 ...
 */
@Portable
public class AnotherDummyJob implements Job<String> {
   ...
   public String execute(JobContext jobContext) {
      ...
      String resultString = "RESULT: AnotherDummyJob Completed. Init Time = " + dateString;
      if (jobContext.getDataMap().containsKey("TestKeyCron_1")) {
         resultString = "CRON = " + resultString + ". Cron Data " + jobContext.getDataMap().get("TestKeyCron_1");
      }
      return resultString;
   }
