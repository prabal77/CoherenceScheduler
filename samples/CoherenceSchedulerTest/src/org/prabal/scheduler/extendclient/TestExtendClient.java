 ...
 * 
 */
package org.prabal.scheduler.extendclient;
...
public class TestExtendClient {
   ...
   public static void main(String[] args) {
      ...
      properties.setProperty("tangosol.coherence.override", "/tangosol-coherence-override-extend.xml");
      properties.setProperty("tangosol.coherence.cacheconfig", "/custom-extend-test-cache-config.xml");
