...
public class CoherenceSchedulerFacade {
   ...
   private static final String DEFAULT_SUBMISSION_CACHE = "org.prabal.scheduler.JobSubmissionCache";
   private static final String DEFAULT_RESULT_CACHE = "org.prabal.scheduler.JobResultCache";
   ...
   public SubmissionResult getResultInstanceReadOnly(ResultInstanceKey resultInstanceKey) {
      ObjectProxyFactory<SubmissionResult> objectProxyFactory = new ObjectProxyFactory<SubmissionResult>(DEFAULT_RESULT_CACHE, SubmissionResult.class);
