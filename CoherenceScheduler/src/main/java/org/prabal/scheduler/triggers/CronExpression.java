 ...
 * need to use the '?' character in one of these fields).</li>
 * <li>Overflowing ranges is supported - that is, having a larger number on the left hand side than
 * the right. You might do 22-2 to catch 10 o'clock at night until 2 o'clock in the morning, or you
 * might have NOV-FEB. It is very important to note that overuse of overflowing ranges creates
 * ranges that don't make sense and no effort has been made to determine which interpretation
