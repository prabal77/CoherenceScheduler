...
public class DateBuilder {
   ...
   private DateBuilder() {
      ...
      cal.setTime(ClusterInfoUtil.getCurrentClusterTime());
   ...
   public static Date futureDate(int interval, IntervalUnit unit) {
      ...
      c.setTime(ClusterInfoUtil.getCurrentClusterTime());
      c.setLenient(true);
   ...
   public static Date evenHourDate(Date date) {
      if (date == null) {
         date = ClusterInfoUtil.getCurrentClusterTime();
      }
   ...
   public static Date translateTime(Date date, TimeZone src, TimeZone dest) {
      ...
      Date newDate = ClusterInfoUtil.getCurrentClusterTime();
